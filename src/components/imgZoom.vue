  ...
  export default {
    ...
    methods: {
      handMove(e) {
        ...
        let backgroundX=objX*(Math.ceil(this.bigImg.width/this.imgObj.offsetWidth)/3);
        let backgroundY=objY*(Math.ceil(this.bigImg.height/this.imgObj.offsetHeight)/3);
        //判断是否超出界限
